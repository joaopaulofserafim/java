...
O usuário/jogador terá apenas 5
chances para tentar adivinhar o valor for 
(incrementa). 

A cada tentativa do jogador, caso ele não
acerte, o programa deve informar se o valor digitado é maior ou menor que o
valor escolhido pelo computador
if / else if . 

E caso o valor digitado pelo jogador tenha
...
No final, deverá ser impresso “Parabéns, você ganhou o jogo!”, se o
